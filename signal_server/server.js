...
const WebSocketServer = WebSocket.server;  // 注意这里的调整

// Pathnames of the SSL key and certificate files to use for
// HTTPS connections.

const keyFilePath = "/etc/letsencrypt/live/www.qtai.net.cn/privkey.pem";
const certFilePath = "/etc/letsencrypt/live/www.qtai.net.cn/fullchain.pem";
